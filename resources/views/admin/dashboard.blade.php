...
<head>
    ...
    <title>Archivo Central - Dashboard</title>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total de Decretos</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$cuenta}}</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$cuentau}}</div>
                                        </div>
                                        <div class="col-auto">
